...
int main(){
    SubComponent* head=new SubComponent("总部");
    SubComponent* sichuanOffice =new SubComponent("四川分部");
    Component* office1=new AdminOffice("行政办公室");
    Component* office2=new DeanOffice("教务办公室");

    SubComponent* mianyangOffice=new SubComponent("绵阳分部");
    SubComponent* chengduOffice = new SubComponent("成都分部");
